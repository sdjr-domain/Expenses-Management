/**
 * EmberField - Glowing Ember Field background effect
 */
class EmberField {
    constructor(container, options = {}) {
        if (!container) {
            console.error("EmberField: Container element not found.");
            return;
        }
        this.container = container;
        this.emberCount = Math.min(options.emberCount || 90, 200);

        this.embers = [];
        this.mouse = { x: -9999, y: -9999, active: false, tx: -9999, ty: -9999 };
        this.canvas = null;
        this.ctx = null;
